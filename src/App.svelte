<script>
  ...
  async function lightson(){
    let lockon = await fetch("./lighton")//call api to open lock
  }
  async function lightsoff(){
    let lockon = await fetch("./lightoff")//call api to open lock
  }

  async function checkson(){
    let lockon = await fetch("./oncheck")//call api to open lock
  }
  async function checksoff(){
    let lockon = await fetch("./offcheck")//call api to open lock
  }
  async function nextson(){
    let lockon = await fetch("./onnext")//call api to open lock
  }
  async function nextsoff(){
    let lockon = await fetch("./offnext")//call api to open lock
  }
  async function doneson(){
    let lockon = await fetch("./ondone")//call api to open lock
  }
  async function donesoff(){
    let lockon = await fetch("./offdone")//call api to open lock
  }
  async function messengers(){
    let lockon = await fetch("./message?message=${message}")//call api to open lock
  }
